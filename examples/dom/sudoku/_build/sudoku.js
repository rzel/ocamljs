...
var oc$Sudoku$ =
  function () {
    ...
    var d$59 = D$58[1];
    var make_board$60 =
      _f(function (param$242) {
           var make_input$61 =
             _f(function (param$246) {
                  var input$62 = _m(d$59.createElement, d$59, ["input"]);
                  _m(input$62.setAttribute, input$62, ["type", "text"]);
                  input$62.size = 1;
                  input$62.maxLength = 1;
                  var style$63 = input$62.style;
                  style$63.border = "none";
                  style$63.padding = "0px";
                  var enforce_digit$64 =
                    _f(function (param$247) {
                         var match$248 = input$62.value;
                         var $r30 = false;
                         r$30: {
                           if (!oc$$sneq(match$248, "1")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "2")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "3")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "4")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "5")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "6")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "7")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "8")) { $r30 = true;
                                                            break r$30; }
                           if (!oc$$sneq(match$248, "9")) { $r30 = true;
                                                            break r$30; }
                           return input$62.value = "";
                         }
                         if ($r30) return 0;
                       });
                  input$62.onchange = _(oc$Ocamljs$[3], [enforce_digit$64]);
                  return input$62;
                });
           var make_td$65 =
             _f(function (i$66, j$67, input$68) {
                  var td$69 = _m(d$59.createElement, d$59, ["td"]);
                  var style$70 = td$69.style;
                  style$70.borderStyle = "solid";
                  style$70.borderColor = "#000000";
                  var widths$71 =
                    _f(function (param$245) {
                         var $r25 = false;
                         r$25: {
                           if (param$245 < 0 || param$245 > 8) { $r25 = true;
                                                                 break r$25; }
                           switch (param$245)
                           {
                           case 0: return $(2, 0);
                  ...
                  var match$244 = _(widths$71, [i$66]);
                  var match$243 = _(widths$71, [j$67]);
                  var px$76 = _f(function (k$77) { return __(oc$Pervasives$[15], [_(oc$Pervasives$[19], [k$77]), "px"]); });
                  style$70.borderTopWidth = _(px$76, [match$244[0]]);
                  style$70.borderBottomWidth = _(px$76, [match$244[1]]);
                  style$70.borderLeftWidth = _(px$76, [match$243[0]]);
                  style$70.borderRightWidth = _(px$76, [match$243[1]]);
                  _m(td$69.appendChild, td$69, [input$68]);
                  ;
                  return td$69;
                });
           var rows$78 =
             _(oc$Array$[0],
             [9, _f(function (i$79) { return __(oc$Array$[0], [9, _f(function (j$80) { return __(make_input$61, [0]); })]); })]);
           var table$81 = _m(d$59.createElement, d$59, ["table"]);
           _m(table$81.setAttribute, table$81, ["cellpadding", "0px"]);
           _m(table$81.setAttribute, table$81, ["cellspacing", "0px"]);
           var tbody$82 = _m(d$59.createElement, d$59, ["tbody"]);
           _m(table$81.appendChild, table$81, [tbody$82]);
           ;
           _(oc$ArrayLabels$[13],
           [_f(function (i$83, row$84) {
                 var tr$85 = _m(d$59.createElement, d$59, ["tr"]);
                 _(oc$ArrayLabels$[13],
                 [_f(function (j$86, cell$87) {
                       var td$88 = _(make_td$65, [i$83, j$86, cell$87]);
                       _m(tr$85.appendChild, tr$85, [td$88]);
                       return 0;
                     }),
                 row$84]);
                 _m(tbody$82.appendChild, tbody$82, [tr$85]);
                 return 0;
               }),
           rows$78]);
           return $(rows$78, table$81);
         });
    var check_board$89 =
      _f(function (rows$90, param$238) {
           var error$91 =
             _f(function (i$92, j$93) {
                  var cell$94 = oc$$arefs(oc$$arefs(rows$90, i$92), j$93);
                  return cell$94.style.backgroundColor = "#ff0000";
                });
           var check_set$95 =
             _f(function (set$96) {
                  var seen$97 = caml_make_vect(9, 0);
                  return __(oc$ArrayLabels$[11],
                         [_f(function (param$239) {
                               var j$99 = param$239[1];
                               var i$98 = param$239[0];
                               var cell$100 = oc$$arefs(oc$$arefs(rows$90, i$98), j$99);
                               var v$101 = cell$100.value;
                               if (oc$$sneq(v$101, ""))
                               {
                                 var n$102 = caml_int_of_string(v$101);
                                 var match$240 = oc$$arefs(seen$97, n$102 - 1);
                                 if (match$240)
                                 {
                                   var match$241 = match$240[0];
                                   _(error$91, [i$98, j$99]);
                                   return __(error$91, [match$241[0], match$241[1]]);
                                 }
                                 return oc$$asets(seen$97, n$102 - 1, $($(i$98, j$99)));
                               }
                               return 0;
                             }),
                         set$96]);
           ...
           var check_row$105 =
             _f(function (i$106) {
                  return __(check_set$95, [_(oc$Array$[0], [9, _f(function (j$107) { return $(i$106, j$107); })])]);
                });
           var check_column$108 =
             _f(function (j$109) {
                  return __(check_set$95, [_(oc$Array$[0], [9, _f(function (i$110) { return $(i$110, j$109); })])]);
                });
           var check_square$111 =
             _f(function (i$112, j$113) {
                  var set$114 =
                    _(oc$Array$[0], [9, _f(function (k$115) { return $(i$112 * 3 + k$115 % 3, j$113 * 3 + (k$115 / 3 >> 0)); })]);
                  return __(check_set$95, [set$114]);
                });
           _(oc$ArrayLabels$[11],
           [_f(function (row$116) {
                 return __(oc$ArrayLabels$[11],
                        [_f(function (cell$117) { return cell$117.style.backgroundColor = "#ffffff"; }), row$116]);
               }),
           rows$90]);
           var i$118;
           for (i$118 = 0; i$118 <= 8; i$118++) { (function (i$118) { _(check_row$105, [i$118]); }(i$118)); }
           var j$119;
           for (j$119 = 0; j$119 <= 8; j$119++) { (function (j$119) { _(check_column$108, [j$119]); }(j$119)); }
           var i$120;
           for (i$120 = 0;
           i$120 <= 2;
           i$120++) {
             (function (i$120) {
                var j$121;
                for (j$121 = 0; j$121 <= 2; j$121++) { (function (j$121) { _(check_square$111, [i$120, j$121]); }(j$121)); }
              }(i$120));
           }
           return 0;
         });
    var onload$122 =
      _f(function (param$236) {
           var match$237 = _(make_board$60, [0]);
           var check$125 = _m(d$59.getElementById, d$59, ["check"]);
           check$125.onclick = _(oc$Ocamljs$[3], [_(check_board$89, [match$237[0]])]);
           var board$126 = _m(d$59.getElementById, d$59, ["board"]);
           _m(board$126.appendChild, board$126, [match$237[1]]);
           return 0;
         });
    (D$58[0]).onload = _(oc$Ocamljs$[3], [onload$122]);
    return $(D$58, d$59, make_board$60, check_board$89, onload$122);
  }();
